...
const game = {
    ...
    queueUnit(key) {
        ...
        const needsTargeting = ['tactical_drone', 'bomber_drone', 'emp', 'nuke'].includes(key);
        if (needsTargeting) {
    ...
    renderUI() {
        ui.updateUnitButtons(this.currentCategory, this.playerStock, this.cooldowns, this.supply, this.spawnQueue);
        ui.setSkillCount('emp', this.skillCharges.emp);
        ui.setSkillCount('nuke', this.skillCharges.nuke);
    },
