...
const STORAGE_KEY = 'dice_city_v10_sim';
...
const RANKS = [
    { limit: 10000, title: '노숙자', rankEmoji: '🥣', houseEmoji: '📦', houseDesc: '비가 오면 젖습니다.' },
    { limit: 100000, title: '서민', rankEmoji: '🚲', houseEmoji: '🚪', houseDesc: '작지만 아늑한 단칸방.' },
    { limit: 500000, title: '중산층', rankEmoji: '💼', houseEmoji: '🏢', houseDesc: '엘리베이터가 있는 아파트.' },
    { limit: 1000000, title: '부자', rankEmoji: '💎', houseEmoji: '🌆', houseDesc: '한강이 보이는 고급 아파트.' },
    { limit: 10000000, title: '자산가', rankEmoji: '🚁', houseEmoji: '🏰', houseDesc: '정원사가 있는 대저택.' },
    { limit: 100000000, title: '재벌', rankEmoji: '👑', houseEmoji: '🏝️', houseDesc: '개인 소유 섬.' }
];
...
const INITIAL_STATE = {
    ...
    crypto: { 'BTC': { name: 'Bitcoin', price: 60000.00 }, 'ETH': { name: 'Ethereum', price: 3000.00 } },
    futures: [],
    realEstate: {
    ...
    luxury: {
        'phone': { name: '폴더폰', price: 500, count: 0, img: '📱', type: 'essential', desc: '뉴스 열람' },
        'smartphone': { name: '스마트폰', price: 3000, count: 0, img: '📲', type: 'essential', desc: '코인 시세 확인' },
        'gold': { name: '금괴 1kg', price: 65000, count: 0, img: '🧈', type: 'asset', desc: '안전 자산', fixedPrice: false },
        'bag': { name: '루이비통 가방', price: 3000, count: 0, img: '👜', type: 'asset', desc: '명품', fixedPrice: true },
        'shoes': { name: '명품 구두', price: 1500, count: 0, img: '👠', type: 'asset', desc: '명품', fixedPrice: true },
        'ring': { name: '다이아 반지', price: 5000, count: 0, img: '💍', type: 'asset', desc: '청혼용', fixedPrice: true },
        'rolex': { name: '롤렉스', price: 15000, count: 0, img: '⌚', type: 'asset', desc: '성공의 상징', fixedPrice: true },
        'sedan': { name: '고급 세단', price: 60000, count: 0, img: '🚘', type: 'asset', desc: '편안한 승차감', fixedPrice: true },
        'supercar': { name: '람보르기니', price: 300000, count: 0, img: '🏎️', type: 'asset', desc: '부의 상징', fixedPrice: true }
    },
    newsHistory: [],
    partners: [] 
};
